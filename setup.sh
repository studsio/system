...
[ -e /home/vagrant ] && STUDS_BUILD_DIR=/home/vagrant/output-$SYSTEM_NAME

# Make sure build dir exists
mkdir -p $STUDS_BUILD_DIR

# Clean up any old versions of Buildroot
rm -rf $STUDS_SYSTEM/buildroot*
...
echo "Patching..."
$STUDS_SYSTEM/buildroot/support/scripts/apply-patches.sh \
 $STUDS_SYSTEM/buildroot $STUDS_SYSTEM/patches

# Configure build directory
make -C $STUDS_SYSTEM/buildroot BR2_EXTERNAL=$STUDS_SYSTEM O=$STUDS_BUILD_DIR \
